...
Section \ref{sec:JOSS} introduces our Python package \textsc{wakeflow}, while sections \ref{sec:wakeform} and \ref{sec:wakeprop} outline the theory and numerical methods it uses.
